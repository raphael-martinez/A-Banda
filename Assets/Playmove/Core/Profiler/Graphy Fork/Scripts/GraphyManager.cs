...
namespace Tayx.Graphy
{
    ...
    public class GraphyManager : G_Singleton<GraphyManager>
    {
        ...
        [SerializeField] private    ModuleState             m_audioModuleState                  = ModuleState.OFF;
        ...
        [SerializeField] private    ModuleState             m_advancedModuleState               = ModuleState.OFF;
        ...
        private                     ModulePreset            m_modulePresetState                 = ModulePreset.FPS_FULL_RAM_FULL;
        ...
        public void PresetChange(int mode)
        {
            switch (mode)
            {
                case 1:
                    SetPreset(ModulePreset.FPS_BASIC);
                    break;    
                case 2:
                    SetPreset(ModulePreset.FPS_TEXT_RAM_TEXT);
                    break; 
                case 3:
                    SetPreset(ModulePreset.FPS_FULL_RAM_FULL);
                    break; 
            }
        }
